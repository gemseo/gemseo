...
-  :class:`~gemseo.core.mdo_scenario.MDOScenario` builds the process from a set of inputs, several
   ...
   process when its :code:`execute()` method is called. Through this class, the
...
-  :class:`~gemseo.core.doe_scenario.DOEScenario` builds the process from a set of inputs, several
   ...
   when its :code:`execute()` method is called. Through this class, the user
...
-  :class:`~gemseo.core.discipline.MDODiscipline` represents a wrapped :term:`simulation software` program or a chain of wrapped
   ...
   represented in a **Grammar** (see :class:`~gemseo.core.grammar.SimpleGrammar` or :class:`~gemseo.core.json_grammar.JSONGrammar`).
...
-  :class:`~gemseo.core.function.MDOFunction` instances (for the :term:`objective function` and the possible constraints) are
...
-  :class:`~gemseo.core.function.MDOFunctionGenerator` is a utility class that handles the
   :class:`~gemseo.core.function.MDOFunction` generation for a given :class:`~gemseo.core.discipline.MDODiscipline`.
