...
The construction of an [Discipline][gemseo.core.discipline.discipline.Discipline] consists in three steps:

1. Instantiate the [Discipline][gemseo.core.discipline.discipline.Discipline] using the super constructor,
2. Initialize the grammars using the [BaseGrammar.update_from_names][gemseo.core.grammars.base_grammar.BaseGrammar.update_from_names] method,
3. Set the default inputs from the initial **`inputs.txt`**.

The `Discipline._run()` method consists in three steps:

1. Write the **`inputs.txt`** file,
