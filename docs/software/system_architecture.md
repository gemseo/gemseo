...
- [DesignSpace][gemseo.space.design.DesignSpace] is an attribute of the [OptimizationProblem][gemseo.optimization.problem.OptimizationProblem] that describes the design variables, their bounds, their type (float or integer), and current value. This object can be read from a file.
