...
- [MDOFunction][gemseo.core.mdo_functions.mdo_function.MDOFunction] instances (for the objective function and the possible constraints) are generated by the [BaseMDOFormulation][gemseo.formulations.base_mdo.BaseMDOFormulation]. Depending on the formulation, constraints may be generated as well (*e.g.* consistency constraints in IDF).
