...
An [EvaluationProblem][gemseo.core.problem.evaluation.EvaluationProblem] is the simplest form of computational problem.
...
defined on a [DesignSpace][gemseo.space.design.DesignSpace].
It is formalized as,
...
The observables are [ArrayFunction][gemseo.core.function.array_function.ArrayFunction] instances
added to the evaluation problem via [add_observable()][gemseo.core.problem.evaluation.EvaluationProblem.add_observable].
...
is typically used to process an [EvaluationProblem][gemseo.core.problem.evaluation.EvaluationProblem],
that is, to evaluate its functions.

!!! note

    For post-processing purposes,
    the evaluations contained in the [Database][gemseo.core.problem.database.Database]
    can be exported to an HDF file or a [Dataset][gemseo.dataset.dataset.Dataset],
...
[EvaluationProblem][gemseo.core.problem.evaluation.EvaluationProblem] does with [functions][concept-functions]
what [EvaluationScenario][gemseo.scenario.evaluation.EvaluationScenario] does with [disciplines][concept-discipline].
