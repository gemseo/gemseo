...
- in memory:
    - [SimpleCache][gemseo.caches.simple.SimpleCache] (default policy)
    ...
    - [MemoryFullCache][gemseo.caches.memory_full.MemoryFullCache]
      ...
      prefer
      [HDF5Cache][gemseo.caches.hdf5.HDF5Cache] in that case;
- on disk:
...
!!! warning
    - The [MemoryFullCache][gemseo.caches.memory_full.MemoryFullCache]
    ...
    - The [HDF5Cache][gemseo.caches.hdf5.HDF5Cache]
...
!!! note
    ...
    or [MemoryFullCache][gemseo.caches.memory_full.MemoryFullCache].
    The method
    [set_cache()][gemseo.core.discipline.discipline.Discipline.set_cache]
    discovers the new types automatically
    through the
    [CacheFactory][gemseo.caches.factory.CacheFactory].
...
with [BaseCache.to_dataset()][gemseo.caches.base.BaseCache.to_dataset];
