...
| Thin plate spline (TPS)          | SciPy                      | [TPSRegressor][gemseo.machine_learning.regression.model.tps.TPSRegressor] ([settings][gemseo.machine_learning.regression.model.tps_settings.TPSRegressor_Settings])                                                                    |
