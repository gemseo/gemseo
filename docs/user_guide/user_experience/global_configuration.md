...
- `directory_manager`, default: disabled - The directory manager configuration; use `settings.enable = True` to enable the directory manager. Once enabled, it cannot be disabled for the rest of the process.
