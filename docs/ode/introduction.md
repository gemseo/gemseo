...
The ODE module integrates the solution of first-order ordinary differential equations in GEMSEO
...
The solution of an IVP consists in identifying the function $y: [t_0, t_f]\rightarrow \mathbb{R}^n$
...
The [algorithms][available-ordinary-differential-equations-solvers] available in GEMSEO, developed in the method `solve_ivp`
