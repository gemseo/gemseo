...
In this tutorial,
you will create an [EvaluationScenario][gemseo.scenario.evaluation.EvaluationScenario]
...
# [AnalyticDiscipline][gemseo.discipline.analytic.AnalyticDiscipline] type
...
# [DesignSpace][gemseo.space.design.DesignSpace] that you will define.
#
...
#
# Then,
# you define an [EvaluationScenario][gemseo.scenario.evaluation.EvaluationScenario]
# from the [Discipline][gemseo.core.discipline.discipline.Discipline]
# and the [DesignSpace][gemseo.space.design.DesignSpace] defined above:
...
#     [CustomDOE_Settings][gemseo.doe.custom_doe.settings.custom_doe_settings.CustomDOE_Settings]
#     pydantic model.
#
...
#
# Two different groups are made in the [Dataset][gemseo.dataset.dataset.Dataset]:
#
