...
In this example, we illustrate the use of the [ObjConstrHist][gemseo.post.obj_constr_hist.ObjConstrHist] post-processing
on the Sobieski's SSBJ problem.

The [ObjConstrHist][gemseo.post.obj_constr_hist.ObjConstrHist] post-processing plots the history of the objective
