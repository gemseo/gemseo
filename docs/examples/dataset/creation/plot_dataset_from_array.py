...
In this example, we will see how to build a [Dataset][gemseo.datasets.dataset.Dataset] from an NumPy array.
"""
...
#
# We create a [Dataset][gemseo.datasets.dataset.Dataset] from the NumPy array only
...
#     the default group [Dataset.DEFAULT_GROUP][gemseo.datasets.dataset.Dataset.DEFAULT_GROUP] is considered.
