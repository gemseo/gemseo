...
# For that,
# we instantiate
# the discipline [SobieskiMission][gemseo.problems.mdo.sobieski.disciplines.SobieskiMission]
...
# by means of the class [SobieskiDesignSpace][gemseo.problems.mdo.sobieski.core.design_space.SobieskiDesignSpace]
# and [DesignSpace.filter()][gemseo.algos.design_space.DesignSpace.filter] the inputs of the
# discipline [SobieskiMission][gemseo.problems.mdo.sobieski.disciplines.SobieskiMission]
...
# by means of the [sample_disciplines()][gemseo.sample_disciplines] function
