...
#
#
# The [get_available_opt_algorithms()][gemseo.get_available_opt_algorithms] function returns the list
...
# %%
# See [this page][algorithm-settings] for more information on how to use settings models.
