...
# [MDOScenarioAdapter][gemseo.disciplines.scenario_adapters.mdo_scenario_adapter.MDOScenarioAdapter] to wrap an [MDOScenario][gemseo.scenarios.mdo.MDOScenario] and treat it as a
...
# These inputs are generated by the outer [MDOScenario][gemseo.scenarios.mdo.MDOScenario] using a full factorial
# method.
...
#
# An [MDOScenarioAdapter][gemseo.disciplines.scenario_adapters.mdo_scenario_adapter.MDOScenarioAdapter] wraps an entire [MDOScenario][gemseo.scenarios.mdo.MDOScenario] as a
...
# !!! tip
#
#     In a [MDOScenario][gemseo.scenarios.mdo.MDOScenario], we know a priori the samples that will be evaluated.
