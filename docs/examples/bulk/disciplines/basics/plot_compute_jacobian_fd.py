...
# %%
# First,
# we create a discipline, e.g. an [AutoPyDiscipline][gemseo.disciplines.auto_py.AutoPyDiscipline]:
def f(a=0.0, b=0.0):
    y = a**2 + b
    z = a**3 + b**2
    return y, z
...
#
# By default,
# GEMSEO uses [default_input_data][gemseo.core.discipline.discipline.Discipline.default_input_data] as input data
