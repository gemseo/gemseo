...
r"""# Multi-objective Poloni example with the mNBI algorithm.

In this example,
the modified Normal Boundary Intersection (mNBI) algorithm is used to
solve the [Poloni][gemseo.problems.multiobjective_optimization.poloni.Poloni] problem:
...
!!! quote "References"
    ...
    [Hybridization of a multi-objective genetic algorithm, a neural network and a classical optimizer for a complex design problem in fluid dynamics](https://www.sciencedirect.com/science/article/pii/S0045782599003941).
