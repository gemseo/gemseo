...
- [plot_bar()][gemseo.uncertainty.sensitivity.base.BaseSensitivityAnalysis.plot_bar]
  draws a horizontal bar chart of the main indices for one output;
- [plot_radar()][gemseo.uncertainty.sensitivity.base.BaseSensitivityAnalysis.plot_radar]
  draws a radar (spider) chart of the main indices for one output,
- [plot()][gemseo.uncertainty.sensitivity.base.BaseSensitivityAnalysis.plot]
...
# ## Summary
#
# - [plot_bar(output)][gemseo.uncertainty.sensitivity.base.BaseSensitivityAnalysis.plot_bar]
#   draws a bar chart of main indices per input variable;
# - [plot_radar(output)][gemseo.uncertainty.sensitivity.base.BaseSensitivityAnalysis.plot_radar]
#   draws a radar chart of main indices per input variable;
# - [plot(output)][gemseo.uncertainty.sensitivity.base.BaseSensitivityAnalysis.plot]
