...
![Open a reference input file](figs/gui_template_1.png)

![select the input and press the Input button (Ctrl+I) to generate the template tag](figs/gui_template_2.png)

![Enter the input name](figs/gui_template_3.png)

![The GUI highlights the inputs that are tagged in the template](figs/gui_template_4.png)

![The user saves the input template (Ctrl+S)](figs/gui_template_5.png)

![Same for the outputs, shortcut (Ctrl+O)](figs/gui_template_6.png)
