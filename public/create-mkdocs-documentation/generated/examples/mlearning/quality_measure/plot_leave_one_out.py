...
# The idea is simple:
# we repeat iterate $N$ times the two-step task
# "1) learn from $N-1$ samples, 2) predict from the remainder"
# and finally approximate the measure from the $N$ predictions.
#
...
#
# For this,
# we can take these $N=7$ learning input points
...
# We can take a closer look by storing the $N$ sub-models:
rmse.compute_leave_one_out_measure(store_resampling_result=True)
