...
In this example, we illustrate the use of the [ScatterPlotMatrix][gemseo.post.scatter_plot_matrix.ScatterPlotMatrix
post-processing on the Sobieski's SSBJ problem.

The [ScatterPlotMatrix][gemseo.post.scatter_plot_matrix.ScatterPlotMatrix post-processing provide the scatter plot matrix among
