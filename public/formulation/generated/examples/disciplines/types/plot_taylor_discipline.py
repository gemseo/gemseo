...
# %%
# Let us consider a discipline computing $y$ from $x=(x_1,x_2)$
# using the function
#
...
# using the first-order Taylor polynomial of $f$ at an input point $a$:
#
# $$
#    f_a(x) = \begin{pmatrix}
...
#
# For that,
# we can instantiate the [TaylorDiscipline][gemseo.disciplines.taylor.TaylorDiscipline] from the previous `discipline`,
...
#
# We can also use a custom value of $a$,
# *e.g.* $(0.2, -0.8)$ (and compare the results):
