...
In this example,
we will see how to build and manipulate a [Dataset][gemseo.datasets.dataset.Dataset].

From a conceptual point of view,
a [Dataset][gemseo.datasets.dataset.Dataset] is a tabular data structure
...
a [Dataset][gemseo.datasets.dataset.Dataset] is a particular
...
# %%
# Let us check that the class [Dataset][gemseo.datasets.dataset.Dataset] derives from `pandas.DataFrame`:
...
#
# The method [get_view()][gemseo.datasets.dataset.Dataset.get_view] returns a view of the dataset
