...
generated by an [BasePost][gemseo.post.base_post.BasePost].
...
# %%
# Then,
# we can post-process this [MDOScenario][gemseo.scenarios.mdo_scenario.MDOScenario] with an [OptHistoryView][gemseo.post.opt_history_view.OptHistoryView].
opt_post_processor = scenario.post_process(
    post_name="OptHistoryView", show=True, save=False
)

# %%
# Instead of saving or showing this [OptHistoryView][gemseo.post.opt_history_view.OptHistoryView],
# and so the associated [figures][gemseo.post.opt_history_view.OptHistoryView.figures],
