...
#
#
# To create a standard [DesignSpace][gemseo.algos.design_space.DesignSpace],
# the API function [create_design_space()][gemseo.create_design_space] can be used.
#
# - This function does not take any argument.
# - This function returns an empty instance of [DesignSpace][gemseo.algos.design_space.DesignSpace].
...
# the API function [read_design_space()][gemseo.read_design_space] can be used.
#
...
# - This function returns an instance of [DesignSpace][gemseo.algos.design_space.DesignSpace].
...
#
#
# To export an instance of [DesignSpace][gemseo.algos.design_space.DesignSpace] into an HDF or CSV file,
# the [write_design_space()][gemseo.write_design_space] API function can be used:
