...
In this example,
we illustrate the use of the [ParallelCoordinates][gemseo.post.dataset.parallel_coordinates.ParallelCoordinates] plot
on the Sobieski's SSBJ problem.

The [ParallelCoordinates][gemseo.post.dataset.parallel_coordinates.ParallelCoordinates] post-processing provides parallel coordinates plots
among design variables, outputs functions and constraints.

The [ParallelCoordinates][gemseo.post.dataset.parallel_coordinates.ParallelCoordinates] portrays the design variables history during the
