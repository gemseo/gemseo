...
In this example, we illustrate the use of the [Robustness][gemseo.post.robustness.Robustness] plot
on the Sobieski's SSBJ problem.

The [Robustness][gemseo.post.robustness.Robustness] post-processing plots the robustness of the optimum in a box
