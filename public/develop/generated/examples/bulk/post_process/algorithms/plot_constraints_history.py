...
In this example, we illustrate the use of the [ConstraintsHistory][gemseo.post.constraints_history.ConstraintsHistory]
post-processing on the Sobieski's SSBJ problem.

The [ConstraintsHistory][gemseo.post.constraints_history.ConstraintsHistory] post-processing plots the history of the constraints
...
[OptHistoryView][gemseo.post.opt_history_view.OptHistoryView] but scales less with the number of constraints.
"""
