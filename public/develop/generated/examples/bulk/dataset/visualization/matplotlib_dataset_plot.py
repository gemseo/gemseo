...
In this example,
we will see how to modify the matplotlib figures generated by a [DatasetPlot][gemseo.post.dataset.base.BaseDatasetPlot].
...
# It is therefore advisable to check if an attribute of [DatasetPlot][gemseo.post.dataset.base.BaseDatasetPlot] can help
