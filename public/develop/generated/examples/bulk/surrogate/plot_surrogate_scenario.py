...
gemseo.algos.optimization_problem.OptimizationProblem.to_dataset] method,
...
# we build a [RBFRegressor][gemseo.machine_learning.regression.models.rbf.RBFRegressor]
# of $y_4$
...
# [LinearRegressor][gemseo.machine_learning.regression.models.linreg.LinearRegressor]
# which has
...
#   for that use the
#   [LinearRegressor][gemseo.machine_learning.regression.models.linreg
#   .LinearRegressor] class.
# - Polynomial regression,
#   based on the [Scikit-learn](http://scikit-learn.org/stable/) library,
#   for that use the
#   [PolynomialRegressor][gemseo.machine_learning.regression.models.polyreg
#   .PolynomialRegressor]
#   class,
...
#   [MOERegressor][gemseo.machine_learning.regression.models.moe.MOERegressor] class,
# - Random forest models,
#   based on the [Scikit-learn](http://scikit-learn.org/stable/) library,
#   for that use the
#   [RandomForestRegressor][gemseo.machine_learning.regression.models.random_forest
#   .RandomForestRegressor]
#   class.
# - RBF models (Radial Basis Functions),
#   using the [SciPy](http://scipy.org/) library,
#   for that use the
#   [RBFRegressor][gemseo.machine_learning.regression.models.rbf.RBFRegressor] class.
# - PCE models (Polynomial Chaos Expansion),
#   based on the [OpenTURNS](https://openturns.github.io/www/) library,
#   for that use the
#   [PCERegressor][gemseo.machine_learning.regression.models.pce.PCERegressor] class.
#
...
# [BaseRegressor][gemseo.machine_learning.regression.models.base_regressor
# .BaseRegressor] base
...
# [RegressorFactory][gemseo.machine_learning.regression.models.factory
# .RegressorFactory] can
# build the new
# [BaseRegressor][gemseo.machine_learning.regression.models.base_regressor
# .BaseRegressor]
