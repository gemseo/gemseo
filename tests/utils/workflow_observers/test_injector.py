...
from gemseo.utils._workflow_observers.injector import _decorate_class
from gemseo.utils._workflow_observers.injector import _match_spec
from gemseo.utils._workflow_observers.injector import _WorkflowObserverInjector
...
class _StubObserver:
    ...
    _spec: ClassVar[ObservationSpec] = ObservationSpec(
        base_class="tests.utils.workflow_observers.test_injector._Target",
...
def enable_observation(monkeypatch):
    ...
    from gemseo.utils._directory_manager.settings import Settings
...
def test_accept_returns_false_when_directory_manager_disabled(monkeypatch):
    from gemseo.utils import global_configuration
    from gemseo.utils._directory_manager.settings import Settings
