...
from gemseo.space.factory import RandomSpaceFactory


@pytest.fixture(scope="module")
def factory() -> RandomSpaceFactory:
    """The factory of random spaces."""
    return RandomSpaceFactory()
