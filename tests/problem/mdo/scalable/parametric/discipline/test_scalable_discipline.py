...
from gemseo.problem.mdo.scalable.parametric.discipline.scalable_discipline import (
    ScalableDiscipline,
)
...
def test_differentiation(scalable_discipline, core_scalable_discipline) -> None:
    ...
    checker = DisciplineJacobianChecker(scalable_discipline)
    assert checker.check(
        input_data,
        approximation_mode=scalable_discipline.LinearizationMode.COMPLEX_STEP,
    )
