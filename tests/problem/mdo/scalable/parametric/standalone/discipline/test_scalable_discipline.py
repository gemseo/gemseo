...
from gemseo.problem.mdo.scalable.parametric.standalone.discipline.scalable_discipline import (  # noqa: E501
    Coefficients,
)
from gemseo.problem.mdo.scalable.parametric.standalone.discipline.scalable_discipline import (  # noqa: E501
    ScalableDiscipline,
...
def test_coefficients(scalable_discipline, coefficients) -> None:
...
def test_execute_x_i(scalable_discipline) -> None:
...
def test_execute_y_1(scalable_discipline) -> None:
...
def test_differentiation_default(scalable_discipline) -> None:
...
def test_differentiation_x_0(scalable_discipline) -> None:
...
def test_differentiation_y_2(scalable_discipline) -> None:
