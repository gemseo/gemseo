...
from gemseo.problem.mdo.scalable.data_driven.diagonal import ScalableDiagonalModel
...
def test_show_close(dataset, save, show) -> None:
    ...
    model = ScalableDiagonalModel(dataset)
    with (
        patch("gemseo.problem.mdo.scalable.data_driven.diagonal.plt.show") as show_,
        patch("gemseo.problem.mdo.scalable.data_driven.diagonal.plt.close") as close_,
        patch(
            "gemseo.problem.mdo.scalable.data_driven.diagonal.save_show_figure"
        ) as save_show_figure,
    ):
