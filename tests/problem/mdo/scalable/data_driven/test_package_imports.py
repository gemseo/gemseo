...
"""Tests for the lazy re-export from `gemseo.problem.mdo.scalable.data_driven`."""

from __future__ import annotations

import gemseo.problem.mdo.scalable.data_driven
from gemseo.util.testing.package_import import make_lazy_reexport_tests

globals().update(
    make_lazy_reexport_tests(
        gemseo.problem.mdo.scalable.data_driven,
        extra_all=(
