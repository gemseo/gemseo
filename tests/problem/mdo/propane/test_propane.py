...
from gemseo.problem.mdo.propane.propane import PropaneReaction
from gemseo.problem.mdo.propane.propane import get_design_space
...
class TestPropaneScenario(unittest.TestCase):
    ...
    def get_x0(self, scenario):
        ...
        """
        data_names = tuple(scenario.formulation.problem.input_space.variables)
