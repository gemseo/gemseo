...
def test_compute_indices(correlation) -> None:
...
def test_correlation_plot(correlation, baseline_images, output) -> None:
...
@image_comparison(None)
def test_correlation_plot_radar(correlation, baseline_images) -> None:
    """Check CorrelationAnalysis.plot_radar()."""
    correlation.compute_indices()
    correlation.plot_radar("y1", save=False, show=False)


def test_aggregate_sensitivity_indices(correlation) -> None:
...
def test_correlation_outputs() -> None:
...
def test_save_load(correlation, tmp_wd) -> None:
