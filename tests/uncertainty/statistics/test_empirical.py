...
def test_compute_joint_probability(statistics, value, kwargs) -> None:
...
def test_plot_boxplot(statistics, snapshot_matplotlib) -> None:
...
def test_plot_boxplot_args(statistics) -> None:
...
def test_plot_cdf(statistics, snapshot_matplotlib) -> None:
...
def test_plot_cdf_args(statistics) -> None:
...
def test_plot_pdf(statistics, snapshot_matplotlib) -> None:
...
def test_plot_pdf_args(statistics) -> None:
