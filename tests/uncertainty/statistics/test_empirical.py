...
def test_plot_boxplot(statistics, pyplot_close_all) -> None:
...
def test_plot_cdf(statistics, pyplot_close_all) -> None:
...
def test_plot_pdf(statistics, pyplot_close_all) -> None:
