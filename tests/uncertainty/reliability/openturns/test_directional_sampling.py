...
from gemseo.uncertainty.reliability.openturns.directional_sampling import (
    OT_DirectionalSampling,
)
from gemseo.uncertainty.reliability.openturns.directional_sampling_settings import (
    OT_DirectionalSampling_Settings,
)
from gemseo.uncertainty.reliability.openturns.root_strategy import OTRiskyAndFast
...
@pytest.mark.parametrize(
    ...
    [
        ...
        OT_DirectionalSampling_Settings(
            ...
            use_random_sampling_strategy=False,
            root_strategy=OTRiskyAndFast(maximum_distance=7.0, step_size=0.9),
        ),
    ],
)
@pytest.mark.parametrize(
...
def test_directional_sampling(function, uncertain_space, settings, greater, expected):
    """Test OT_DirectionalSampling."""
    directional_sampling = OT_DirectionalSampling()
    kwargs = {}
    ...
    results = directional_sampling.execute(problem, **kwargs)
