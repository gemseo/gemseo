...
def test_check_dimension_inconsistency() -> None:
...
def test_samples_shape(n_samples, options) -> None:
...
def test_wrong_arguments(options) -> None:
...
def test_use_custom_doe_directly() -> None:
