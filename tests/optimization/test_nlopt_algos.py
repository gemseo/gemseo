...
def test_no_stop_during_doe_phase(
    ...
    """Test that COBYLA and BOBYQA does not trigger a termination criterion
    during the DoE phase.
    ...
    due to the max iteration termination criterion.
...
def test_cobyla_stopped_due_to_small_crit_n_x(
    ...
    """Test that COBYLA does not trigger a termination criterion during the doe phase.
...
def test_bobyqa_stopped_due_to_small_crit_n_x(
    ...
    """Test that BOBYQA does not trigger a termination criterion during its DoE phase.
