...
from gemseo.problem.mdo.sobieski._disciplines_sg import SobieskiAerodynamicsSG
from gemseo.problem.mdo.sobieski._disciplines_sg import SobieskiMissionSG
from gemseo.problem.mdo.sobieski._disciplines_sg import SobieskiPropulsionSG
...
@patch(
    "gemseo.core.discipline.execution_statistics.ExecutionStatistics.duration", new=1
)
@pytest.mark.parametrize(
