...
from gemseo.util.xdsm.xdsm_to_pdf import XDSM
from gemseo.util.xdsm.xdsmizer import XDSMizer
from gemseo.util.xdsm.xdsmizer import expand
...
if TYPE_CHECKING:
    ...
    from gemseo.util.xdsm.xdsmizer import EdgeType
    from gemseo.util.xdsm.xdsmizer import NodeType
...
def test_xdsmize_bilevel(options) -> None:
    ...
    sc_prop.set_algorithm(settings_model)
    ...
    sc_aero.set_algorithm(settings_model)
