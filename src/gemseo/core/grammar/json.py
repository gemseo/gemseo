...
class JSONGrammar(BaseGrammar):
    ...
    When using
    [update_from_types()][gemseo.core.grammar.json.JSONGrammar.update_from_types],
    ...
    [BaseGrammar][gemseo.core.grammar.base.BaseGrammar].
    ...
    def _update(
        ...
        Raises:
            TypeError: If the grammar is not
                a [JSONGrammar][gemseo.core.grammar.json.JSONGrammar].
        """  # noqa:D417
