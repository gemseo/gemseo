...
from gemseo.core.discipline.namespace import update_nested_namespaces
...
class BaseGrammar(
    ...
    Warning:
        ...
        than the method
        [add_namespace()][gemseo.core.grammar.base.BaseGrammar.add_namespace].
    """
    ...
    def _invalidate_caches(self) -> None:
        ...
        Called by [GrammarProperties][gemseo.core.grammar.properties.GrammarProperties]
