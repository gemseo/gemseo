...
from gemseo.core.function._operation import _OperationFunctionMaker
...
from gemseo.util.metaclass import GoogleDocstringInheritanceMeta
...
class ArrayFunction(metaclass=GoogleDocstringInheritanceMeta):
    ...
    to define the objective function, the constraints and the observables of an
    ...
    e.g.
    [input_names][gemseo.core.function.array_function.ArrayFunction.input_names].

    The wrapped output and Jacobian functions
    can be accessed with the properties
    [func][gemseo.core.function.array_function.ArrayFunction.func]
    and
    [jac][gemseo.core.function.array_function.ArrayFunction.jac].
    ...
    [compute_linear_approximation()][gemseo.core.function.taylor_polynomial.compute_linear_approximation]
    and
    [compute_quadratic_approximation()][gemseo.core.function.taylor_polynomial.compute_quadratic_approximation];
    ...
    Note:
       ...
       (see
       [set_pt_from_database()][gemseo.core.function.array_function.ArrayFunction.set_pt_from_database]).
    ...
    def __init__(
        ...
        Args:
            ...
            special_repr: The string representation of the function.
                If empty, use
                [default_repr][gemseo.core.function.array_function.ArrayFunction.default_repr].
    ...
    def evaluate(self, x_vect: NumberArray) -> OutputType:
        ...
        [dim][gemseo.core.function.array_function.ArrayFunction.dim] is not defined,
        ...
        Returns:
            ...
            [force_real][gemseo.core.function.array_function.ArrayFunction.force_real]
            is `True`.
        """
    ...
    def set_pt_from_database(
        ...
        the method [func()][gemseo.core.function.array_function.ArrayFunction.func]
