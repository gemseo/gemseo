...
"""Data values to NumPy arrays and vice versa from a [SimpleGrammar][gemseo.core.grammar.simple.SimpleGrammar]."""  # noqa: E501
...
if TYPE_CHECKING:
    from gemseo.core.grammar.simple import SimpleGrammar  # noqa: F401
...
class SimpleGrammarDataConverter(BaseDataConverter["SimpleGrammar"]):
    ...
    Warning:
        Since [SimpleGrammar][gemseo.core.grammar.simple.SimpleGrammar]
