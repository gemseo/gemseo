...
if TYPE_CHECKING:
    ...
    from gemseo.util.comparison import DataToCompare
...
class BaseCache(ABCMapping[StrKeyMapping, CacheEntry]):
    ...
    Notes:
        `cache_entry` is a [CacheEntry][gemseo.core.cache.cache_entry.CacheEntry]
    ...
    See Also:
        [SimpleCache][gemseo.core.cache.simple.SimpleCache]
    ...
    def to_dataset(
        ...
        """Build a [Dataset][gemseo.dataset.dataset.Dataset] from the cache.
