...
class ExecutionStatistics(Serializable, metaclass=_Meta):
    ...
    by setting
    [is_enabled][gemseo.core.discipline.execution_statistics.ExecutionStatistics.is_enabled]
    to `True`.
    By default, it is set to `False`.
    When enabled,
    the recording of time stamps can be enabled
    by setting
    [is_time_stamps_enabled][gemseo.core.discipline.execution_statistics.ExecutionStatistics.is_time_stamps_enabled]
    to `True`.
    By default, it is set to `False`.
    ...
    [n_executions][gemseo.core.discipline.execution_statistics.ExecutionStatistics.n_executions],
    [n_linearizations][gemseo.core.discipline.execution_statistics.ExecutionStatistics.n_linearizations],
    [duration][gemseo.core.discipline.execution_statistics.ExecutionStatistics.duration]
    and
    [time_stamps][gemseo.core.discipline.execution_statistics.ExecutionStatistics.time_stamps].
    The time stamps should be processed
    with [create_gantt_chart()][gemseo.post.gantt_chart.create_gantt_chart].
