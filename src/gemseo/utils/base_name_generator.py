...
class BaseNameGenerator(Serializable):
    ...
    def _generate_name(self) -> str | None:
        ...
        If the naming convention is
        [NUMBERED][gemseo.utils.base_name_generator.BaseNameGenerator.Naming.NUMBERED],
        ...
        elif self.__naming == self.Naming.UUID:
            return str(uuid4()).split("-")[-1]
        elif self.__naming == self.Naming.DATED_UUID:
            return (
