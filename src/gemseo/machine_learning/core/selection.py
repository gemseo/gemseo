...
using the class
[MLModelSelection][gemseo.machine_learning.core.selection.MLModelSelection].
...
The [MLModelSelection][gemseo.machine_learning.core.selection.MLModelSelection] does
this.
...
See Also:
   [gemseo.machine_learning.core.models.ml_model][gemseo.machine_learning.core.models.ml_model]
...
if TYPE_CHECKING:
    ...
    from gemseo.machine_learning.core.models.factory import MLModelFactory
