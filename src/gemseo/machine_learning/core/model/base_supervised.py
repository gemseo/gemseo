...
r"""This module contains the base class for the supervised machine learning models.
...
One usually distinguishes between two types of supervised machine learning models,
...
a supervised learning model seeks to find a function
...
The [gemseo.machine_learning.core.model.base_supervised][gemseo.machine_learning.core.model.base_supervised]
...
from gemseo.machine_learning.core.model.base_supervised_settings import (
    BaseMLSupervisedModelSettings,
)
from gemseo.machine_learning.data_formatter.supervised_data_formatters import (
...
if TYPE_CHECKING:
    ...
    from gemseo.machine_learning.core.model.base_ml_model import DefaultTransformerType
    from gemseo.machine_learning.transformer.core.base_transformer import (
        BaseTransformer,
    )
    from gemseo.util.typing import RealArray

SavedObjectType = MLModelSavedObjectType | Sequence[str] | dict[str, ndarray]


class BaseMLSupervisedModel(BaseMLModel):
    """Supervised machine learning model.

    Inheriting classes shall overload the `BaseMLSupervisedModel._fit()` and
    `BaseMLSupervisedModel._predict()` methods.
    """
