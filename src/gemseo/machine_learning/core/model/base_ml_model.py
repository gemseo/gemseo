...
if TYPE_CHECKING:
    ...
    from gemseo.machine_learning.data_formatter.base_data_formatters import (
        BaseDataFormatters,
    )
...
class BaseMLModel(Serializable, metaclass=ABCGoogleDocstringInheritanceMeta):
    ...
    [BaseResampler][gemseo.machine_learning.resampling.core.base_resampler.BaseResampler],
