...
The [gemseo.machine_learning.core.models.supervised][gemseo.machine_learning.core.models.supervised]
...
if TYPE_CHECKING:
    ...
    from gemseo.machine_learning.core.models.ml_model import DefaultTransformerType
