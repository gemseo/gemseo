...
[MLModelAssessor][gemseo.machine_learning.calibration.MLModelAssessor] class
...
a dataset ([Dataset][gemseo.dataset.dataset.Dataset]), a quality measure
...
class MLModelAssessor(Discipline):
    ...
    def _run(self, input_data: StrKeyMapping) -> StrKeyMapping | None:
        ...
        [MLModelAssessor][gemseo.machine_learning.calibration.MLModelAssessor].
