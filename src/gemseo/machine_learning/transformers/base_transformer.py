...
[fit()][gemseo.machine_learning.transformers.base_transformer.BaseTransformer.fit],
[transform()][gemseo.machine_learning.transformers.base_transformer.BaseTransformer.transform],
and possibly
[inverse_transform()][gemseo.machine_learning.transformers.base_transformer.BaseTransformer.inverse_transform],
methods.

See Also:
   [gemseo.machine_learning.transformers.scaler.scaler][gemseo.machine_learning.transformers.scaler.scaler]
   [gemseo.machine_learning.transformers.dimension_reduction][gemseo.machine_learning.transformers.dimension_reduction]
"""
...
class BaseTransformer(metaclass=ABCGoogleDocstringInheritanceMeta):
    ...
    """Whether the [fit()][gemseo.machine_learning.transformers.base_transformer.BaseTransformer.fit] method requires two data arrays."""  # noqa: E501
...
class TransformerFactory(BaseFactory):
    ...
    _PACKAGE_NAMES = ("gemseo.machine_learning.transformers",)
