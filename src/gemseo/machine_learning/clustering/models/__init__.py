...
Use the
[ClustererFactory][gemseo.machine_learning.clustering.models.factory.ClustererFactory]
...
or
[BasePredictiveClusterer][gemseo.machine_learning.clustering.models.base_predictive_clusterer.BasePredictiveClusterer]
class
to add a new one.
"""
