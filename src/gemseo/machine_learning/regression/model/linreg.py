...
[coefficients][gemseo.machine_learning.regression.model.linreg.LinearRegressor.coefficients]
and
[intercept][gemseo.machine_learning.regression.model.linreg.LinearRegressor.intercept].
