...
if TYPE_CHECKING:
    from gemseo.dataset.dataset import DataType
...
class BaseRandomProcessRegressor(BaseRegressor):
    ...
    def predict_std(
        ...
        Warning:
           ...
           You can sample the
           [predict()][gemseo.machine_learning.regression.core.base_random_process_regressor.BaseRandomProcessRegressor.predict]
           method
