...
from gemseo.machine_learning._basis.factory import BasisFactory
from gemseo.machine_learning.linear_model_fitting.factory import (
    LinearModelFitterFactory,
)
from gemseo.machine_learning.regression.models.base_fce import BaseFCERegressor
...
class FCERegressor(BaseFCERegressor):
    ...
    this regression model can use any linear model fitting model,
