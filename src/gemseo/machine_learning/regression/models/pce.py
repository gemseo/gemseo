...
from gemseo.machine_learning.regression.models.pce_settings import CleaningOptions
...
class PCERegressor(BaseFCERegressor):
    ...
    def covariance(self) -> RealArray:
        ...
        Warning:
           ...
           You can sample the
           [predict()][gemseo.machine_learning.regression.models.pce.PCERegressor.predict]
