...
between the output scalar variables $y_1,\ldots,y_p$
and the input scalar variables $x_1,\ldots,x_d$
is linear, i.e.
...
Given $n$ observations of these variables,
we obtain:
...
[LinearRegression][gemseo.machine_learning.linear_model_fitting.linear_regression.LinearRegression],
[Lasso][gemseo.machine_learning.linear_model_fitting.lasso.Lasso],
[Ridge][gemseo.machine_learning.linear_model_fitting.ridge.Ridge],
[LARS][gemseo.machine_learning.linear_model_fitting.lars.LARS],
[ElasticNet][gemseo.machine_learning.linear_model_fitting.elastic_net.ElasticNet],
and [OrthogonalMatchingPursuit][gemseo.machine_learning.linear_model_fitting.omp.OrthogonalMatchingPursuit].
"""  # noqa: E501
