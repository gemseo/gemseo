...
from gemseo.util.metric.base_composite import BaseCompositeMetric

if TYPE_CHECKING:
    from gemseo.dataset.dataset import ComponentType
    from gemseo.dataset.dataset import IndexType
    from gemseo.dataset.dataset import StrColumnType
