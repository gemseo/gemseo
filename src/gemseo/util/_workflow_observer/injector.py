...
from gemseo.util._workflow_observer.optimizer import (
    OptimizerWorkflowObserver as _OptimizerWorkflowObserver,
)
from gemseo.util._workflow_observer.scenario import (
...
if TYPE_CHECKING:
    ...
    from gemseo.util._workflow_observer.base_observer import InjectableObserver
