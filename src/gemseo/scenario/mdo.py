...
class MDOScenario(EvaluationScenario):
    ...
    or [add_observable()][gemseo.scenario.mdo.MDOScenario.add_observable] respectively.
    ...
    Then,
    the [MDOScenario.execute()][gemseo.scenario.mdo.MDOScenario.execute] method
    takes a driver
    (see
    ...
    To view the results,
    use the
    [MDOScenario.post_process()][gemseo.scenario.mdo.MDOScenario.post_process]
    ...
    def get_result(self, name: str = "", **options: Any) -> ScenarioResult | None:
        ...
        returned by [execute()][gemseo.scenario.mdo.MDOScenario.execute].
    ...
    def execute(
        ...
        Returns:
            ...
            accessible via [get_result()][gemseo.scenario.mdo.MDOScenario.get_result].
        """  # noqa: D205, D212
