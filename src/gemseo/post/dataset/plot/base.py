...
class BasePlot(Generic[T], metaclass=ABCGoogleDocstringInheritanceMeta):
    ...
    while a [BasePlot][gemseo.post.dataset.plot.base.BasePlot]
    ...
    def _get_variable_names(
        self,
        dataset_columns: Iterable[tuple[str, str, int]],
    ) -> list[str]:
        """Return the names of the variables from the columns of a pandas DataFrame.

        Args:
            dataset_columns: The [Dataset][gemseo.dataset.dataset.Dataset] columns.
