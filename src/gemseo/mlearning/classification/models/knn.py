...
The k-nearest neighbor classification model is an approach
...
through voting.
The model may also predict the probabilities of belonging to each class
...
[KNNClassifier][gemseo.mlearning.classification.models.knn.KNNClassifier] class
deriving from
[BaseClassifier][gemseo.mlearning.classification.models.base_classifier.BaseClassifier].
