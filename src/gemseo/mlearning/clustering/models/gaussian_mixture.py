...
r"""The Gaussian mixture model for clustering.

The Gaussian mixture model groups the data into clusters.
...
[GaussianMixture][gemseo.mlearning.clustering.models.gaussian_mixture.GaussianMixture]
class
deriving from
[BaseClusterer][gemseo.mlearning.clustering.models.base_clusterer.BaseClusterer].

## Dependence

This clustering model relies on the GaussianMixture class
