...
r"""The k-means model for clustering.

The k-means model groups the data into clusters,
...
[KMeans][gemseo.mlearning.clustering.models.kmeans.KMeans]
class deriving from
[BaseClusterer][gemseo.mlearning.clustering.models.base_clusterer.BaseClusterer].

## Dependence

This clustering model relies on the KMeans class
