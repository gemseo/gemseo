...
Use the
[ClustererFactory][gemseo.mlearning.clustering.models.factory.ClustererFactory]
...
or
[BasePredictiveClusterer][gemseo.mlearning.clustering.models.base_predictive_clusterer.BasePredictiveClusterer]
class
to add a new one.
"""
