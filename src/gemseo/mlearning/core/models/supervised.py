...
The [gemseo.mlearning.core.models.supervised][gemseo.mlearning.core.models.supervised]
module implements this concept through the
[BaseMLSupervisedModel][gemseo.mlearning.core.models.supervised.BaseMLSupervisedModel]
class based on an
...
if TYPE_CHECKING:
    ...
    from gemseo.mlearning.core.models.ml_model import DefaultTransformerType
