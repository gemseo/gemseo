...
from gemseo.mlearning.regression.models.base_fce_settings import (
...
class BaseFCERegressor(BaseRegressor):
    ...
    def mean_jacobian_wrt_special_variables(self) -> RealArray:
        ...
        See
        [predict_jacobian_wrt_special_variables()][gemseo.mlearning.regression.models.base_fce.BaseFCERegressor.predict_jacobian_wrt_special_variables]
    ...
    def mean(self) -> RealArray:
        ...
        Warning:
           ...
           You can sample the
           [predict()][gemseo.mlearning.regression.models.base_fce.BaseFCERegressor.predict]
           method
