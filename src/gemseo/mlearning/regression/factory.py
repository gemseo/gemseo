...
This module contains a factory to instantiate a :class:`.BaseMLRegressionAlgo` from its
...
class RegressionModelFactory(MLAlgoFactory):
    """This factory instantiates a :class:`.BaseMLRegressionAlgo` from its class name.
