...
$W_w=f(A,\ell,\Lambda,N_z,q,S_w,t_c,W_{dg},W_{fw},W_p)$ whose components are
...
The wing weight problem is presented in the following reference
and the description given here is based on that of
[OpenTURNS](https://openturns.github.io/openturns/latest/usecases/use_case_wingweight.html).
