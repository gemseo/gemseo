...
[ScalableDiagonalApproximation][gemseo.problem.mdo.scalable.data_driven.diagonal.ScalableDiagonalApproximation].
With regard to the diagonal DOE, GEMSEO proposes the
[DiagonalDOE][gemseo.doe.diagonal_doe.diagonal_doe.DiagonalDOE] class.
"""
