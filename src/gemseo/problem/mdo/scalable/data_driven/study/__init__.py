...
The
[gemseo.problem.mdo.scalable.data_driven.study][gemseo.problem.mdo.scalable.data_driven.study]
package implements several classes
to benchmark MDO formulations based on scalable disciplines.

The
[ScalableDiagonalModel][gemseo.problem.mdo.scalable.data_driven.diagonal.ScalableDiagonalModel]
class implements
...
2. For each discipline, the user adds a dataset stored
   in a [BaseFullCache][gemseo.core.cache.base_full.BaseFullCache]
...
5. Lastly, the user executes the
   ...
   [ScalabilityResult][gemseo.problem.mdo.scalable.data_driven.study.result.ScalabilityResult].

The
[PostScalabilityStudy][gemseo.problem.mdo.scalable.data_driven.study.post.PostScalabilityStudy]
