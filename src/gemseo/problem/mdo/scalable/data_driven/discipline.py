...
The module
[gemseo.problem.mdo.scalable.data_driven.discipline][gemseo.problem.mdo.scalable.data_driven.discipline]
...
It is composed
of a [ScalableModel][gemseo.problem.mdo.scalable.data_driven.model.ScalableModel].

The user only needs to provide:

- the name of a class overloading
  [ScalableModel][gemseo.problem.mdo.scalable.data_driven.model.ScalableModel],
- a dataset as a [Dataset][gemseo.dataset.dataset.Dataset]
...
The [ScalableModel][gemseo.problem.mdo.scalable.data_driven.model.ScalableModel]
