...
The
[ScalabilityStudy][gemseo.problem.mdo.scalable.data_driven.study.process.ScalabilityStudy]
...
2. For each discipline, the user adds a dataset stored
   in a [Dataset][gemseo.dataset.dataset.Dataset] and select a type of
