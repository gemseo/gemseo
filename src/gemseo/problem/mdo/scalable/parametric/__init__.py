...
See Also:
    [ScalableDiscipline][gemseo.problem.mdo.scalable.parametric.standalone.discipline.scalable_discipline.ScalableDiscipline]
...
The implementation proposes a standalone version that is not based on GEMSEO objects
(only NumPy and SciPy capabilities) to experiment the scalable problem outside GEMSEO
as well as GEMSEO versions of these standalone elements.
...
[create_scenario()][gemseo.problem.mdo.scalable.parametric.scalable_problem.ScalableProblem.create_scenario]
to create a scenario for a
[BaseMDOFormulation][gemseo.formulation.core.base_mdo.BaseMDOFormulation]
and a method
[create_quadratic_programming_problem()][gemseo.problem.mdo.scalable.parametric.scalable_problem.ScalableProblem.create_quadratic_programming_problem]
...
if TYPE_CHECKING:
    ...
    from gemseo.problem.mdo.scalable.parametric.discipline.scalable_discipline import (  # noqa: E501
        ScalableDiscipline,  # noqa: F401
    )
