...
[create_discipline_with_coupled_dynamics()][gemseo.problem.ode.spring.coupled_springs_generator.CoupledSpringsGenerator.create_discipline_with_coupled_dynamics]
or by coupling directly as many instances of
[ODEDiscipline][gemseo.discipline.ode.ode_discipline.ODEDiscipline] as there are masses
(by the method
[create_coupled_ode_disciplines()][gemseo.problem.ode.spring.coupled_springs_generator.CoupledSpringsGenerator.create_coupled_ode_disciplines]).
"""
...
from gemseo.problem.ode.spring.spring_ode_discipline import SpringODEDiscipline
