...
"""The random space of the wing weight problem."""
...
class WingWeightRandomSpace(RandomSpace):
    """The random space of the wing weight problem."""
    ...
    def __init__(
        ...
        for name, (minimum, maximum) in data.items():
            self.add_variable(name, settings_class(minimum=minimum, maximum=maximum))
