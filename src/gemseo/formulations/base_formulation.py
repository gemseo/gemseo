...
class BaseFormulation(Generic[T], metaclass=ABCGoogleDocstringInheritanceMeta):
    ...
    This class creates
    the [MDOFunction][gemseo.core.mdo_functions.mdo_function.MDOFunction] instances
    computing the constraints, objective and observables
    from the disciplines
    and add them to the attached
    [optimization_problem][gemseo.formulations.base_formulation.BaseFormulation.optimization_problem].
    ...
    The link between
    the instances of [Discipline][gemseo.core.discipline.discipline.Discipline],
    the design variables and
    the names of the discipline outputs used as constraints, objective and observables
    is made with the
    [DisciplineAdapterGenerator][gemseo.core.mdo_functions.discipline_adapter_generator.DisciplineAdapterGenerator]`,
    which generates instances of
    ...
    def get_top_level_disciplines(
        ...
        from the
        [design_space][gemseo.formulations.base_formulation.BaseFormulation.design_space]
