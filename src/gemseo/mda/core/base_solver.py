...
from gemseo.mda.sequence_transformer.composite.relaxation_acceleration import (
...
class BaseMDASolver(BaseMDA):
    ...
    def _check_termination_criteria(
        self, update_iteration_metrics: bool = True
    ) -> bool:
        ...
        Returns:
            Whether a termination criterion has been reached.
        """
