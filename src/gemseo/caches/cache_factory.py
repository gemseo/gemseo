...
to instantiate a :class:`.AbstractCache` from its class name.
...
class CacheFactory(object):
    ...
    a :class:`.AbstractCache` from its class name.
    ...
    def is_available(self, cache_name):
        ...
        :param str name:  cache_name of the cache.
