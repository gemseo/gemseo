...
from gemseo.optimization.pareto.util import compute_pareto_optimal_points
from gemseo.util.string import MultiLineString
from gemseo.util.string import _format_value_in_pretty_table_6
...
class ParetoFront:
    ...
    [f_utopia][gemseo.optimization.pareto.pareto_front.ParetoFront.f_utopia]."""
    ...
    [f_utopia][gemseo.optimization.pareto.pareto_front.ParetoFront.f_utopia] is
    [distance_from_utopia][gemseo.optimization.pareto.pareto_front.ParetoFront.distance_from_utopia]
