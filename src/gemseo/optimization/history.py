...
class OptimizationHistory:
    ...
    def feasible_points(
        ...
        [tolerances.equality][gemseo.optimization.problem.OptimizationProblem.tolerances]
        for equality constraints and
        [tolerances.inequality][gemseo.optimization.problem.OptimizationProblem.tolerances]
        for inequality ones.
