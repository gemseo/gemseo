...
from gemseo.optimization._util.linear_constraint import build_constraints_matrices
...
from gemseo.optimization.scipy_linprog.settings.base_scipy_linprog_settings import (
    BaseSciPyLinProgSettings,
)
from gemseo.optimization.scipy_linprog.settings.highs_dual_simplex import (
    DUAL_SIMPLEX_Settings,
)
from gemseo.optimization.scipy_linprog.settings.highs_interior_point import (
...
class ScipyLinProgAlgorithmDescription(OptimizationAlgorithmDescription):
    ...
    settings_class: type[BaseSciPyLinProgSettings] = BaseSciPyLinProgSettings
...
class ScipyLinprog(BaseOptimizationLibrary[BaseSciPyLinProgSettings]):
    ...
    def _run(
        ...
        x_opt = problem.input_space.project_into_bounds(linprog_result.x)
