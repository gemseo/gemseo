...
from gemseo.optimization.history import OptimizationHistory
...
from gemseo.util.hdf5 import store_h5data
    ...
    def add_constraint(
        ...
        Raises:
            TypeError: When the constraint of a linear optimization problem
                is not an
                [LinearFunction][gemseo.core.function.linear_function.LinearFunction].
