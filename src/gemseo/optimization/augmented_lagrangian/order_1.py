...
from gemseo.optimization.augmented_lagrangian.base_penalty_heuristic import (
...
class AugmentedLagrangianOrder1(
    ...
    computed using the
    [LagrangeMultipliers][gemseo.optimization.lagrange_multipliers.LagrangeMultipliers]
    class.
    """
