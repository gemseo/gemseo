...
#
# Taken from https://github.com/horejsek/python-fastjsonschema
# Licence : BSD-3 clause
# Ported to Python2 by Francois Gallard
r"""
Installation
************
...
from .exceptions import JsonSchemaDefinitionException, JsonSchemaException
