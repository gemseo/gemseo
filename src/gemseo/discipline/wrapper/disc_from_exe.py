...
OutputParser = Callable[
    [Mapping[str, tuple[int]], Sequence[str]], Mapping[str, ndarray | float]
]
"""Output parser type."""
...
class DiscFromExe(_BaseDiscFromExe):
    ...
    - The only limitation in the current file format is that
      ...
      [DiscFromExe][gemseo.discipline.wrapper.disc_from_exe.DiscFromExe],
    ...
    def __init__(
        ...
        Args:
            ...
            parse_outfile_method: The optional method that can be provided
                ...
                If the
                [KEY_VALUE][gemseo.discipline.wrapper.disc_from_exe.Parser.KEY_VALUE]
                is used as
                output parser, the user may specify the separator key.
            write_input_file_method: The method to write the input data file.
                If `None`,
                use
                [write_input_file()][gemseo.discipline.wrapper.disc_from_exe.write_input_file]
