...
from gemseo.optimization.aggregation._functions import compute_partial_iks_agg_jac
from gemseo.optimization.aggregation._functions import compute_partial_ks_agg_jac
