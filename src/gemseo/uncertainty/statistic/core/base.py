...
A [BaseStatistics][gemseo.uncertainty.statistic.core.base.BaseStatistics] object
is built from a [Dataset][gemseo.dataset.dataset.Dataset]
...
[BaseStatistics][gemseo.uncertainty.statistic.core.base.BaseStatistics] object.
By default,
this name is the concatenation of the name
of the class overloading
[BaseStatistics][gemseo.uncertainty.statistic.core.base.BaseStatistics]
and the name of the [Dataset][gemseo.dataset.dataset.Dataset].
...
- [compute_minimum()][gemseo.uncertainty.statistic.core.base.BaseStatistics.compute_minimum]: the minimum value,
- [compute_maximum()][gemseo.uncertainty.statistic.core.base.BaseStatistics.compute_maximum]: the maximum value,
- [compute_range()][gemseo.uncertainty.statistic.core.base.BaseStatistics.compute_range]: the difference
  between minimum and maximum values,
- [compute_mean()][gemseo.uncertainty.statistic.core.base.BaseStatistics.compute_mean]: the expectation (a.k.a. mean value),
- [compute_moment()][gemseo.uncertainty.statistic.core.base.BaseStatistics.compute_moment]: a central moment,
  which is the expected value
  of a specified integer power
  of the deviation from the mean,
- [compute_variance()][gemseo.uncertainty.statistic.core.base.BaseStatistics.compute_variance]: the variance,
  which is the mean squared variation around the mean value,
- [compute_standard_deviation()][gemseo.uncertainty.statistic.core.base.BaseStatistics.compute_standard_deviation]: the standard deviation,
  which is the square root of the variance,
- [compute_variation_coefficient()][gemseo.uncertainty.statistic.core.base.BaseStatistics.compute_variation_coefficient]`: the coefficient of variation,
  which is the standard deviation normalized by the mean,
- [compute_quantile()][gemseo.uncertainty.statistic.core.base.BaseStatistics.compute_quantile]: the quantile associated with a probability,
  ...
  the range into *q* continuous interval with equal probabilities are also implemented:
    ...
    - [compute_quartile()][gemseo.uncertainty.statistic.core.base.BaseStatistics.compute_quartile]
      whose order (1, 2 or 3) implements the 4-quantiles (25%, 50% and 75%),
    - [compute_percentile()][gemseo.uncertainty.statistic.core.base.BaseStatistics.compute_percentile]
      whose order (1, 2, ..., 99) implements the 100-quantiles (1%, 2%, ..., 99%),

- [compute_probability()][gemseo.uncertainty.statistic.core.base.BaseStatistics.compute_probability]:
  the probability that the random variable is larger or smaller
  than a certain threshold,
- [compute_tolerance_interval()][gemseo.uncertainty.statistic.core.base.BaseStatistics.compute_tolerance_interval]:
  ...
  (this proportion is the coverage level)
    ...
    - [compute_a_value()][gemseo.uncertainty.statistic.core.base.BaseStatistics.compute_a_value]:
