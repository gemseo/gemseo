...
The base class
[BaseParametricStatistics][gemseo.uncertainty.statistic.core.base_parametric.BaseParametricStatistics]
to estimate statistics parametrically,
using probability distributions fitted to
a [Dataset][gemseo.dataset.dataset.Dataset] at instantiation.

For each variable of this [Dataset][gemseo.dataset.dataset.Dataset],

1. the parameters of the distributions are calibrated
   from this [Dataset][gemseo.dataset.dataset.Dataset],
...
if TYPE_CHECKING:
    ...
    from gemseo.uncertainty.distribution.core.base_fitter import MeasureType
    ...
    def __init__(
        ...
        Args:
            ...
            fitting_criterion: The name of the fitting criterion
                ...
                Use
                [get_criteria()][gemseo.uncertainty.statistic.core.base_parametric.BaseParametricStatistics.get_criteria]
