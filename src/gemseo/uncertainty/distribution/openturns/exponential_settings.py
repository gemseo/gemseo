...
"""Settings for the OpenTURNS-based exponential distributions."""

from __future__ import annotations

from gemseo.uncertainty.distribution.core.base_univariate_settings.exponential import (
...
class OTExponentialDistribution_Settings(  # noqa: N801
    BaseExponentialDistributionSettings, BaseOTMarginalDistributionSettings
):
