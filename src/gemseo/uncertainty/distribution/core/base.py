...
[mean][gemseo.uncertainty.distribution.core.base.BaseDistribution.mean]
and
[standard_deviation][gemseo.uncertainty.distribution.core.base.BaseDistribution.standard_deviation]
We can also get the numerical
[range][gemseo.uncertainty.distribution.core.base.BaseDistribution.range]
and the mathematical
[support][gemseo.uncertainty.distribution.core.base.BaseDistribution.support].
...
([compute_cdf()][gemseo.uncertainty.distribution.core.base.BaseDistribution.compute_cdf])
for the different marginals of the random variable,
as well as the inverse cumulative density function
([compute_inverse_cdf()][gemseo.uncertainty.distribution.core.base.BaseDistribution.compute_inverse_cdf]).

Lastly, we can compute realizations of the random variable
using the
[compute_samples()][gemseo.uncertainty.distribution.core.base.BaseDistribution.compute_samples])
method.
"""
