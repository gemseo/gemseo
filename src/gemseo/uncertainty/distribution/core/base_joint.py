...
[mean][gemseo.uncertainty.distribution.core.base_joint.BaseJointDistribution.mean] and
[standard_deviation][gemseo.uncertainty.distribution.core.base_joint.BaseJointDistribution.standard_deviation].
We can also get the numerical
[range][gemseo.uncertainty.distribution.core.base_joint.BaseJointDistribution.range]
and the mathematical
[support][gemseo.uncertainty.distribution.core.base_joint.BaseJointDistribution.support].
...
([compute_cdf()][gemseo.uncertainty.distribution.core.base_joint.BaseJointDistribution.compute_cdf])
for the different marginals of the random variable,
as well as the inverse cumulative density function
([compute_inverse_cdf()][gemseo.uncertainty.distribution.core.base_joint.BaseJointDistribution.compute_inverse_cdf]).

Lastly, we can compute realizations of the random variable
by means of the
[compute_samples()][gemseo.uncertainty.distribution.core.base_joint.BaseJointDistribution.compute_samples]
method.
"""
