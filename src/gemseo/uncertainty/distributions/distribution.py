...
class Distribution(object):
    ...
    def plot_all(
        ...
        Args:
            ...
            prefix: The filename prefix. If None, do not use any prefix.
        """
    ...
    def plot(
        ...
        Args:
            ...
            prefix: The filename prefix. If None, do not use any prefix.
        """
        variable_name = "{}({})".format(self.variable_name, index)
        ...
        ax2.set_title("CDF")
        file_name = "distribution_{}_{}".format(self.variable_name, index)
        if show:
            plt.show()
        if save:
