...
class Jactor(BaseFunctor):
    ...
    def __call__(self, time: RealArray, state: RealArray) -> RealArray:
        ...
        Returns: The Jacobian of the function at the given time and state.

        """  # noqa: D205, D212, D415
        return self._adapter.jac(self._compute_input_vector(time, state))
